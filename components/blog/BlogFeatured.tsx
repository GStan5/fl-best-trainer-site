...
export default function BlogFeatured({ featuredPost, handlePostSelect }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-black/40 to-navy/40 backdrop-blur-sm border border-white/5 shadow-xl cursor-pointer hover:border-royal/30 hover:shadow-royal/10 transition-all duration-300"
