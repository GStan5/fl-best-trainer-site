...
const CancelBookingModal: React.FC<CancelBookingModalProps> = ({
  ...
  // No scroll lock - allow users to scroll on mobile if modal is tall
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[9999] overflow-y-auto">
          ...
          {/* Modal Container */}
          <div
            className="flex min-h-full items-start justify-center p-3 sm:p-4"
            style={{
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-gradient-to-br from-slate-900 to-slate-800 border border-white/20 rounded-2xl shadow-2xl w-full max-w-md p-4 sm:p-6 z-10"
              style={{
                position: "relative",
                zIndex: 10,
                maxHeight: "90vh",
